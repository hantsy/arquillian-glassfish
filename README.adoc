...
*WARNING: Please use https://github.com/OmniFish-EE/arquillian-container-glassfish[OmniFish EE Arquillian Glassfish] as the replacement if you encountered some weird issues.*
