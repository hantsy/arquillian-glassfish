...
public class GlassFishRestClient {
    ...
    /**
     * Get the HTTP/HTTPS port system property for a server instance.
     * The property is optional — it is generated by GlassFish only when
     * multiple server instances run on the same node.
     */
